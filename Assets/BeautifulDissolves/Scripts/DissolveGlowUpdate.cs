...
namespace BeautifulDissolves {
	...
	public class DissolveGlowUpdate : MonoBehaviour
	{
		...
		[SerializeField] 
		private StartMode m_StartMode = StartMode.OnAwake;
		[SerializeField]
		private UpdateRate m_UpdateRate = UpdateRate.EveryFrame;
		[SerializeField]
		private GlowSource m_GlowSource = GlowSource.Emissive;

		[Range(0f, 1f)]
		[SerializeField]
		private float m_GlowCutoff = 1f;
		[SerializeField]
		private int m_FrameDelay = 2;
		[SerializeField]
		private float m_UpdateTimestep = 0.02f;
		[SerializeField]
